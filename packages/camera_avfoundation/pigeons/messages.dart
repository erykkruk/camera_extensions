...
@ConfigurePigeon(
  PigeonOptions(
    ...
    dartPackageName: 'camera_extended_ios',
    objcHeaderOut:
        'ios/camera_extended_ios/Sources/camera_avfoundation_objc/include/camera_avfoundation/messages.g.h',
    objcSourceOut:
        'ios/camera_extended_ios/Sources/camera_avfoundation_objc/messages.g.m',
...
// Pigeon version of CameraAspectRatio.
enum PlatformCameraAspectRatio {
...
class PlatformMediaSettings {
  ...
  final PlatformCameraAspectRatio aspectRatio;
}
