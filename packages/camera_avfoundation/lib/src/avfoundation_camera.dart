...
class AVFoundationCamera extends CameraPlatform {
    ...
    try {
      return await _hostApi.create(
        ...
        PlatformMediaSettings(
          ...
          aspectRatio: _pigeonAspectRatio(mediaSettings?.aspectRatio),
        ),
      );
    } on PlatformException catch (e) {
      throw CameraException(e.code, e.message);
  ...
  /// Returns a [CameraAspectRatio]'s Pigeon representation.
  PlatformCameraAspectRatio _pigeonAspectRatio(CameraAspectRatio? aspectRatio) {
    if (aspectRatio == null) {
      return PlatformCameraAspectRatio.ratioDefault;
    }
    switch (aspectRatio) {
      case CameraAspectRatio.ratio16x9:
        return PlatformCameraAspectRatio.ratio16x9;
      case CameraAspectRatio.ratio4x3:
        return PlatformCameraAspectRatio.ratio4x3;
      case CameraAspectRatio.ratio1x1:
        return PlatformCameraAspectRatio.ratio1x1;
