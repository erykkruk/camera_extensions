...
@implementation FCPPlatformCameraAspectRatioBox
- (instancetype)initWithValue:(FCPPlatformCameraAspectRatio)value {
  self = [super init];
  if (self) {
    _value = value;
  }
...
+ (instancetype)makeWithResolutionPreset:(FCPPlatformResolutionPreset)resolutionPreset
    ...
    aspectRatio:(FCPPlatformCameraAspectRatio)aspectRatio {
...
+ (FCPPlatformMediaSettings *)fromList:(NSArray<id> *)list {
  ...
  FCPPlatformCameraAspectRatioBox *boxedFCPPlatformCameraAspectRatio = GetNullableObjectAtIndex(list, 5);
  pigeonResult.aspectRatio = boxedFCPPlatformCameraAspectRatio.value;
  return pigeonResult;
}
+ (nullable FCPPlatformMediaSettings *)nullableFromList:(NSArray<id> *)list {
...
- (NSArray<id> *)toList {
  return @[
    ...
    @(self.enableAudio),
    [[FCPPlatformCameraAspectRatioBox alloc] initWithValue:self.aspectRatio],
  ];
}
@end
...
- (nullable id)readValueOfType:(UInt8)type {
  switch (type) {
    ...
    case 138: {
      NSNumber *enumAsNumber = [self readValue];
      return enumAsNumber == nil ? nil : [[FCPPlatformCameraAspectRatioBox alloc] initWithValue:[enumAsNumber integerValue]];
    }
    case 139: 
...
- (void)writeValue:(id)value {
  if ([value isKindOfClass:[FCPPlatformCameraLensDirectionBox class]]) {
    ...
    [self writeByte:137];
    [self writeValue:(value == nil ? [NSNull null] : [NSNumber numberWithInteger:box.value])];
  } else if ([value isKindOfClass:[FCPPlatformCameraAspectRatioBox class]]) {
    FCPPlatformCameraAspectRatioBox *box = (FCPPlatformCameraAspectRatioBox *)value;
    [self writeByte:138];
    [self writeValue:(value == nil ? [NSNull null] : [NSNumber numberWithInteger:box.value])];
