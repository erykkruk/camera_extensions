...
typedef NS_ENUM(NSUInteger, FCPPlatformCameraAspectRatio) {
  /// 16:9 widescreen aspect ratio.
  FCPPlatformCameraAspectRatioRatio16x9 = 0,
  /// 4:3 standard aspect ratio.
  FCPPlatformCameraAspectRatioRatio4x3 = 1,
  /// 1:1 square aspect ratio.
  FCPPlatformCameraAspectRatioRatio1x1 = 2,
  /// Use the camera's default aspect ratio.
  FCPPlatformCameraAspectRatioRatioDefault = 3,
};

/// Wrapper for FCPPlatformCameraAspectRatio to allow for nullability.
@interface FCPPlatformCameraAspectRatioBox : NSObject
@property(nonatomic, assign) FCPPlatformCameraAspectRatio value;
...
@property(nonatomic, assign) FCPPlatformCameraAspectRatio aspectRatio;
@end
